...
$sql = "SELECT * FROM `san_pham` WHERE `ten` LIKE '%$search%' LIMIT $start, $limit";
$ket_qua = mysqli_query($connect, $sql);

$row = mysqli_num_rows(mysqli_query($connect, "SELECT * FROM `san_pham` WHERE `ten` LIKE '%$search%'"));
...
<div id="page-wrapper" >
    <div class="header"> 
        <h1 class="page-header">
            Danh sách sản phẩm <small>Responsive tables</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="#">aaaa</a></li>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><img height=100 src="../anh/<?php echo $san_pham['anh']?>"></td>
                                                <td><a href="xl_xoa.php?id=<?php echo$san_pham['id']?>&anh=<?php echo $san_pham['anh']?>"><img height=50 src="../anh/trash-solid.svg" style=" display:block; margin:auto;"></a></td>
                                                <td><a href="index.php?trang=sua_sp&id=<?php echo$san_pham['id']?>"><img height=50 src="../anh/square-pen-solid.svg" style=" display:block; margin:auto;"></a></td>
                                            </tr>
                                    <?php
                                        }
                                    ?>
